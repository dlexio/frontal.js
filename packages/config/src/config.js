...
module.exports = class Config {
	...
	getFileConfig() {
		...
		if (!is.function(sandbox.module.exports) && !is.object(sandbox.module.exports)) {
			throw new Error(
		...
		return is.function(sandbox.module.exports) ? sandbox.module.exports() : sandbox.module.exports
	}
}
